...
def get_posts(request):
    ...
    Render to blogposts.html template
    """
...
def post_detail(request, pk):
    """
    Create a view that returns a single Post object based on the ID (pk) and
    render it to postdetail.html template OR return a 404 error
    """
